...
const SignUp = () => {
  return (
    <div className='flex flex-col items-center justify-center min-w-96 mx-auto'>
      <div className='w-full p-6 rounded-lg shadow-md bg bg-gray-600 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-40'>
        ...
        <form>
          ...
          <a href="#" className='text-sm hover:underline hover:text-amber-600 mt-2 inline-block'>Already have an account?</a>
          <div>
